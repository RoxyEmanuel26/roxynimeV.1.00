...
const PROVIDERS: ProviderOption[] = [
    { id: "otakudesu", name: "Server 1", icon: "1️⃣", description: "Sumber utama", contentType: "Anime" },
    { id: "samehadaku", name: "Server 2", icon: "2️⃣", description: "Khusus Movies", contentType: "Movie" },
];
