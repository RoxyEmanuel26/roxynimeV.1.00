/**
 * route.ts - /sitemap_anime_[id].xml
 * Sitemap untuk halaman anime detail (/anime/[slug]).
 * Per 1000 URL per chunk, baca dari public/cache/anime-list.json.
...
export async function GET(
  ...
  try {
    const cache = await readCacheFile<AnimeCache>("anime-list.json");
