...
export default async function WatchPage({ params, searchParams }: PageProps) {
    ...
    // Attempt to get anime slug to fetch details for Prev/Next navigation
    ...
    try {
        if (targetSlug && targetSlug !== episodeId) {
            anime = await animbus.getAnimeInfo(targetSlug, source);
